...
public class TransacaoTest {
    ...
    void deveCriarTransacaoCorretamente() {
        Transacao transacao = new Transacao(TipoTransacao.DEPOSITO, BigDecimal.valueOf(100.0), "Depósito inicial");

        assertEquals(TipoTransacao.DEPOSITO, transacao.getTipo());
        assertEquals(BigDecimal.valueOf(100.0), transacao.getValor());
    ...
    void toStringDeveRetornarFormatoCorreto() {
        Transacao transacao = new Transacao(TipoTransacao.SAQUE, BigDecimal.valueOf(50.0), "Retirada");
